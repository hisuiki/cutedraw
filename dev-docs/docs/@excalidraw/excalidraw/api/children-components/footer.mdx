...
Earlier we were using `renderFooter` prop to render custom footer which was removed in [#5970](https://github.com/hisuiki/cutedraw/pull/5970). Now you can pass a `Footer` component instead to render the custom UI for footer.
