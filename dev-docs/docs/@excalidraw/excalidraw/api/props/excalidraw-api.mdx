...
<pre>
  (api:{" "}
  <a href="https://github.com/hisuiki/cutedraw/blob/main/packages/excalidraw/types.ts#L616">
    ExcalidrawAPI
  </a>
  ) => void;
</pre>
...
You can use this prop when you want to access some [Excalidraw APIs](https://github.com/hisuiki/cutedraw/blob/main/packages/excalidraw/types.ts#L616). We expose the below APIs :point_down:
...
<pre>
  (scene:{" "}
  <a href="https://github.com/hisuiki/cutedraw/blob/main/packages/excalidraw/types.ts#L339">
    sceneData
  </a>
  ) => void
</pre>
...
| --- | --- | --- |
| `elements` | [`ImportedDataState["elements"]`](https://github.com/hisuiki/cutedraw/blob/main/packages/excalidraw/data/types.ts#L38) | The `elements` to be updated in the scene |
| `appState` | [`ImportedDataState["appState"]`](https://github.com/hisuiki/cutedraw/blob/main/packages/excalidraw/data/types.ts#L39) | The `appState` to be updated in the scene. |
| `collaborators` | <code>Map<string, <a href="https://github.com/hisuiki/cutedraw/blob/main/packages/excalidraw/types.ts#L37">Collaborator></a></code> | The list of collaborators to be updated in the scene. |
| `captureUpdate` | [`CaptureUpdateAction`](https://github.com/hisuiki/cutedraw/blob/main/packages/excalidraw/store.ts#L40) | Controls which updates should be captured by the `Store`. Captured updates are emmitted and listened to by other components, such as `History` for undo / redo purposes. |
...
<pre>
  ...
  <a href="https://github.com/hisuiki/cutedraw/blob/main/packages/excalidraw/types.ts#L249">
    LibraryItemsSource
  </a>
  ;<br /> merge?: boolean; <br /> prompt?: boolean;
  <br /> openLibraryMenu?: boolean;
  <br /> defaultStatus?: "unpublished" | "published"; <br /> &#125;) => Promise&lt;
  <a href="https://github.com/hisuiki/cutedraw/blob/main/packages/excalidraw/types.ts#L246">
    LibraryItems
  </a>
  &gt;
</pre>
...
| --- | --- | --- | --- |
| `libraryItems` | [LibraryItemsSource](https://github.com/hisuiki/cutedraw/blob/main/packages/excalidraw/types.ts#L249) | \_ | The `libraryItems` to be replaced/merged with current library |
  ...
  return (
    <div style={{ height: "500px" }}>
      ...
      <Excalidraw
        ...
        // initial data retrieved from https://github.com/hisuiki/cutedraw/blob/main/dev-docs/packages/excalidraw/initialData.js
        initialData={{
...
<pre>
  (files:{" "}
  <a href="https://github.com/hisuiki/cutedraw/blob/main/packages/excalidraw/types.ts#L59">
    BinaryFileData
  </a>
  ) => void
</pre>
...
<pre>
  () =>{" "}
  <a href="https://github.com/hisuiki/cutedraw/blob/main/packages/excalidraw/element/types.ts#L115">
    ExcalidrawElement[]
  </a>
</pre>
...
<pre>
  () =>{" "}
  <a href="https://github.com/hisuiki/cutedraw/blob/main/packages/excalidraw/types.ts#L95">
    AppState
  </a>
</pre>
...
| --- | --- | --- | --- |
| target | [ExcalidrawElement](https://github.com/hisuiki/cutedraw/blob/main/packages/excalidraw/element/types.ts#L115) &#124; [ExcalidrawElement[]](https://github.com/hisuiki/cutedraw/blob/main/packages/excalidraw/element/types.ts#L115) | All scene elements | The element(s) to scroll to. |
...
<pre>
  () =>{" "}
  <a href="https://github.com/hisuiki/cutedraw/blob/main/packages/excalidraw/types.ts#L82">
    files
  </a>
</pre>
...
| Name | Type | Default | Description |
| --- | --- | --- | --- |
| `type` | [ToolType](https://github.com/hisuiki/cutedraw/blob/main/packages/excalidraw/types.ts#L91) | `selection` | The tool type which should be set as active tool |
