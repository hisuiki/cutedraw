...
| [`UIOptions`](/docs/@excalidraw/excalidraw/api/props/ui-options) | `object` | [DEFAULT UI OPTIONS](https://github.com/hisuiki/cutedraw/blob/main/packages/excalidraw/constants.ts#L151) | To customise UI options. Currently we support customising [`canvas actions`](/docs/@excalidraw/excalidraw/api/props/ui-options#canvasactions) |
...
Beyond attributes that Excalidraw elements already support, you can store `custom` data on each `element` in a `customData` object. The type of the attribute is [`Record<string, any>`](https://github.com/hisuiki/cutedraw/blob/main/packages/excalidraw/element/types.ts#L66) and is optional.
...
1. `excalidrawElements`: Array of [excalidrawElements](https://github.com/hisuiki/cutedraw/blob/main/packages/excalidraw/element/types.ts#L114) in the scene.

2. `appState`: [AppState](https://github.com/hisuiki/cutedraw/blob/main/packages/excalidraw/types.ts#L95) of the scene.

3. `files`: The [BinaryFiles](https://github.com/hisuiki/cutedraw/blob/main/packages/excalidraw/types.ts#L64) which are added to the scene.
...
3.`pointersMap`: [`pointers`](https://github.com/hisuiki/cutedraw/blob/main/packages/excalidraw/types.ts#L131) map of the scene

```js
(exportedElements, appState, canvas) => void
```

1. `exportedElements`: An array of [non deleted elements](https://github.com/hisuiki/cutedraw/blob/main/packages/excalidraw/element/types.ts#L87) which needs to be exported.
2. `appState`: [AppState](https://github.com/hisuiki/cutedraw/blob/main/packages/excalidraw/types.ts#L95) of the scene.
...
<pre>
  (activeTool:{" "}
  <a href="https://github.com/hisuiki/cutedraw/blob/main/packages/excalidraw/types.ts#L115">
    {" "}
    AppState["activeTool"]
  </a>
  , pointerDownState: <a href="https://github.com/hisuiki/cutedraw/blob/main/packages/excalidraw/types.ts#L424">
    PointerDownState
  </a>) => void
</pre>
...
<pre>
  (data:{" "}
  <a href="https://github.com/hisuiki/cutedraw/blob/main/packages/excalidraw/clipboard.ts#L18">
    ClipboardData
  </a>
...
<pre>
  (items:{" "}
  <a href="https://github.com/hisuiki/cutedraw/blob/main/packages/excalidraw/types.ts#L200">
    LibraryItems
  </a>
  ) => void | Promise&lt;any&gt;
</pre>
...
<pre>
  (element:{" "}
  <a href="https://github.com/hisuiki/cutedraw/blob/main/packages/excalidraw/element/types.ts#L114">
    ExcalidrawElement
  </a>
...
Determines the `language` of the UI. It should be one of the [available language codes](https://github.com/hisuiki/cutedraw/blob/main/packages/excalidraw/i18n.ts#L14). Defaults to `en` (English). We also export default language and supported languages which you can import as shown below.
