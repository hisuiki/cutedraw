...
<pre>
  &#123;
  <br /> canvasActions?: <a href="https://github.com/hisuiki/cutedraw/blob/main/packages/excalidraw/types.ts#L372">
    CanvasActions
...
This prop indicates at what point should we break to a docked, permanent sidebar. If not passed it defaults to [`MQ_RIGHT_SIDEBAR_MAX_WIDTH_PORTRAIT`](https://github.com/hisuiki/cutedraw/blob/main/packages/excalidraw/constants.ts#L161).
