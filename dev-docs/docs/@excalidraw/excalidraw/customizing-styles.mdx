...
For a complete list of variables, check [theme.scss](https://github.com/hisuiki/cutedraw/blob/main/packages/excalidraw/css/theme.scss), though most of them will not make sense to override.
