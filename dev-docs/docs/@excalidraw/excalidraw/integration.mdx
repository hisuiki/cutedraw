...
Here is a [source code](https://github.com/hisuiki/cutedraw/tree/main/examples/with-nextjs) for the example with app and pages router. You you can try it out [here](https://excalidraw-package-example-with-nextjs.vercel.app/).

The `types` are available at `@excalidraw/excalidraw/types`, check [CodeSandbox](https://codesandbox.io/p/sandbox/github/hisuiki/cutedraw/tree/main/examples/with-script-in-browser) example for details.
