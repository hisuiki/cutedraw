...
[This](https://github.com/hisuiki/cutedraw/blob/main/src/index.ts) is the entry point of the library.
...
![image](https://github.com/hisuiki/cutedraw/assets/11256141/8e060de7-b867-44ad-864b-0c1b24466b67)
...
![image](https://github.com/hisuiki/cutedraw/assets/11256141/2c24cf7b-f096-4c12-88db-55520de27558)
...
[`processMermaidTextWithOptions`](https://github.com/hisuiki/cutedraw/blob/main/src/parseMermaid.ts#L13) takes the mermaid defination and options and returns the full defination including the mermaid [directives ](https://mermaid.js.org/config/directives.html).

![image](https://github.com/hisuiki/cutedraw/assets/11256141/3a4825d8-9704-468c-a02f-7e507f4d5b7a)
...
For each diagram type, we need a parser as the result of every diagram would differ and dependinng on the data we have to write the parser. Since currently we support flowchart, so here is the [`parseMermaidFlowChartDiagram`](https://github.com/hisuiki/cutedraw/blob/main/src/parser/flowchart.ts#L256) to parse the flowchart diagram.
...
Now we have all the data, we just need to transform it to [ExcalidrawElementSkeleton](https://github.com/hisuiki/cutedraw/blob/main/packages/excalidraw/data/transform.ts#L133C13-L133C38) API so it can be rendered in Excalidraw.
...
For supported types, currently only flowchart, we have [flowchartConverter](https://github.com/hisuiki/cutedraw/blob/main/src/converter/types/flowchart.ts#L24) which parses the data and converts to [ExcalidrawElementSkeleton](https://github.com/hisuiki/cutedraw/blob/main/packages/excalidraw/data/transform.ts#L133C13-L133C38).

![image](https://github.com/hisuiki/cutedraw/assets/11256141/00226e9d-043d-4a08-989a-3ad9d2a574f1)