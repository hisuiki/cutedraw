...
Go to [@excalidraw/mermaid-to-excalidraw](https://github.com/hisuiki/cutedraw) and clone the repository to your local.


```bash
git clone git@github.com:hisuiki/cutedraw.git
```
...
Update the package name and version in [package.json](https://github.com/hisuiki/cutedraw/blob/main/package.json) and run the below command to publish it
