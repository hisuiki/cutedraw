...
Pull requests are welcome. For major changes, please [open an issue](https://github.com/hisuiki/cutedraw/issues/new) first to discuss what you would like to change.

We have a [roadmap](https://github.com/hisuiki/cutedraw) which we strongly recommend to go through and check if something interests you.
...
>
> ```bash
> git remote add upstream https://github.com/hisuiki/cutedraw
> git fetch upstream
...
1. Go to https://codesandbox.io/p/github/hisuiki/cutedraw
...
To translate Excalidraw into other languages, please visit [our Crowdin page](https://crowdin.com/project/excalidraw). To add a new language, [open an issue](https://github.com/hisuiki/cutedraw/issues/new) so we can get things set up on our end first.
